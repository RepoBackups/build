...
# Copyright (C) 2012-2015, The Candy5 Project
#
...
custom_local_manifest = ".repo/local_manifests/candy5_manifest.xml"
custom_default_revision = "c5.1"
custom_dependencies = "candy5.dependencies"
